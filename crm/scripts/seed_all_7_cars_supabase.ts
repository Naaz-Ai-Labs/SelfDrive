...
async function seedCleanFleetToSupabase() {
  console.log("--- SEEDING CLEAN VEHICLE FLEET TO SUPABASE POSTGRESQL ---");
  ...
  // Clear existing vehicles & photos to ensure clean IDs without automatic variants
  ...
  if (error) {
    ...
    console.log("✅ Successfully upserted clean 17 vehicles to Supabase PostgreSQL!");
  }
  ...
  console.log("✅ Successfully upserted clean vehicle photos to Supabase PostgreSQL!");
}

seedCleanFleetToSupabase();
