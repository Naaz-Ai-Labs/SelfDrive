  ...
  return (
    <div className="mt-6 space-y-4">
      <div className="relative flex items-center justify-center">
        ...
        <span className="absolute bg-white px-3 text-xs uppercase tracking-wider text-ink-400">
          Or continue with
        </span>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 pt-2">
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg border border-ink-200 bg-white px-4 py-2.5 text-sm font-medium text-ink-700 shadow-sm transition hover:bg-ink-50 hover:text-ink-900 focus:outline-none focus:ring-2 focus:ring-amber-500/20 disabled:opacity-50"
        >
          {loadingProvider === "google" ? (
            <span className="h-4 w-4 animate-spin rounded-full border-2 border-ink-400 border-t-transparent" />
          ) : (
