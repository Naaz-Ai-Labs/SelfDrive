        ...
        return (
          <Link
            ...
            className={cn(
              ...
              active ? "bg-brand-500 text-ink-950 font-semibold shadow-xs" : "text-ink-300 hover:bg-white/5 hover:text-white"
            )}
          >
            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className={active ? "text-ink-950" : "text-ink-500 group-hover:text-white"} aria-hidden>
              <path d={item.icon} />
            </svg>
